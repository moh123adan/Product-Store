...
import User from '../models/userModel'; // Importing the IUser interface
...
export {
    createUser, deleteUser, forgotPassword,
    getResetPasswordToken, getUserProfile, getUsers, googleLogin, loginUser,
    logoutUser,
    registerUser, resetPassword, updateUser, updateUserProfile
};
